    ...
    <body>
        <div class="bg-image" style="background-image: url(img/pin.png); height: 380vh;">
                        ...
                        <div class="card-body">
                            <form method="POST" action="#">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="nama_admin" class="form-control" value="<?php echo $row['nama_admin']?>" required>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="email_admin" class="col-sm-3 col-form-label"> Email Admin </label>
                                    <div class="col-sm-9">
                                        <input type="text" name="email_admin" class="form-control" value="<?php echo $row['email_admin']?>" required>
                                    </div>
                                </div>
            ...
            if(isset($_POST['edit'])){
                ...
                $sql= "UPDATE admin SET nama_admin='$_POST[nama_admin]', email_admin='$_POST[email_admin]', password='$_POST[password]' WHERE id_admin='$_GET[id]'";
                
                if(mysqli_query($koneksi, $sql)){
                    echo "<script> alert('Data Berhasil Diupdate') </script>";
                    
                    echo "<meta HTTP-EQUIV='REFRESH' content='5; url=accadmin.php'>";
                } 
                else{
